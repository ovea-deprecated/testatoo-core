...
/**
 * This class allows the testing of ComboBox properties.
...
public class ComboBox extends ListModel implements SimpleSelectable, LabelSupport {
    ...
    /**
     * Class constructor specifying the evaluator to use and the id of the comboBox we want to test.
     * The constructor checks if the given id does correspond to a comboBox.
     *
     * @param evaluator a technology specific evaluator
     * @param id        the id (unique) of the comboBox
     */
    public ComboBox(Evaluator evaluator, String id) {
        super(evaluator, id);
        checkIsExpectedComponent(ComboBox);
    }
